...
class RvNewsAdapter(private val clickListener: NewsClickListener) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsViewHolder {
    val withDataBinding: NewsItemBinding =
        DataBindingUtil.inflate(
            LayoutInflater.from(parent.context), NewsViewHolder.LAYOUT, parent, false)
...
class NewsViewHolder(val viewDataBinding: NewsItemBinding) :
  ...
  companion object {
    @LayoutRes val LAYOUT = R.layout.news_item
  }
}
